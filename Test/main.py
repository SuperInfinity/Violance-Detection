...
from_email = "**please enter ur email**"  # must match the email used to generate the password
to_email = "**please enter ur email**"  # receiver email
...
class ObjectDetection:
    def __init__(self, capture_index):
        ...
        # model information
        self.model = YOLO("../Models/voilanceD.pt")
